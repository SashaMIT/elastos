                        ...
                        <div className="md:col-span-2">
                          ...
                          >
                            ...
                            <div className="mb-8">
                              ...
                              {/* Step Screenshot */}
                              <div className="rounded-lg border border-white/10 overflow-hidden mb-6 shadow-lg max-w-sm mx-auto">
                                <img 
                                  src={`/bridge-step${activeStepIndex + 1}.jpg`}
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step1.png" alt="Select networks" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step2.png" alt="Select ELA token" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step3.png" alt="Enter amount" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step4.png" alt="Enable token" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step5.png" alt="Bridge token" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step6.png" alt="View bridged tokens" className="w-full" />
                                          </div>
                                        </div>
                                    ...
                                    <div>
                                      ...
                                      <div className="mb-6">
                                        <div className="bg-white/5 rounded-lg border border-white/10 p-5 mb-4">
                                          ...
                                          <div className="rounded-lg overflow-hidden border border-white/10">
                                            <img src="/glide-bridge-steps/step7.png" alt="After bridging" className="w-full" />
                                          </div>
                                        </div>
                      ...
                      <TabsContent value="change" className="border border-white/10 rounded-lg p-4">
                        <div className="space-y-6">
                          ...
                          <div className="rounded-xl overflow-hidden border border-white/10 shadow-lg">
                            <img 
                              src="/chainge/chainge-interface.png" 
