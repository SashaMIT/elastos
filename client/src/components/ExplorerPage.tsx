            ...
            >
              <div className="p-6">
                ...
                <a
                  ...
                  className={`inline-flex px-3 py-2 ${
                    chain.name.includes("ESC") || chain.name.includes("EID") 
                      ? "bg-[rgba(92,142,255,0.15)] text-white border-[rgba(92,142,255,0.15)]" 
                ...
                >
                  ...
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 35 34" fill="none">
                    <circle cx="17.333" cy="17" r="16.75" stroke={chain.name.includes("ESC") || chain.name.includes("EID") ? "#5C8EFF" : "#F6921A"} strokeOpacity="0.15" strokeWidth="0.25"/>
                    ...
                    <path d="M20.7628 17.6638H10.8747V16.3365H20.7628H20.7929L20.7716 16.3152L16.4338 11.9774L17.3338 11.0775L23.2564 17.0002L17.3338 22.9228L16.4338 22.0229L20.7716 17.6851L20.7929 17.6638H20.7628Z" stroke={chain.name.includes("ESC") || chain.name.includes("EID") ? "#5C8EFF" : "#F6921A"} strokeOpacity="0.15" strokeWidth="0.25"/>
                  </svg>
                </a>
              </div>
