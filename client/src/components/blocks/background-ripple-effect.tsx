...
export const BackgroundCells = ({ children, className }: BackgroundCellsProps) => {
  return (
    <div className={cn("relative h-screen flex justify-center overflow-hidden bg-background dark:bg-[#171717] [background:linear-gradient(to_bottom,transparent_0%,#171717_100%)]", className)}>
      <BackgroundCellCore />
      {children && (
  ...
  return (
    ...
    >
      <div className="absolute h-[20rem] inset-y-0 overflow-hidden">
        <div className="absolute h-full w-full pointer-events-none -bottom-2 z-40 bg-[#171717] [mask-image:linear-gradient(to_bottom,transparent,#171717)]" />
        <div
