    ...
    <div className="min-h-screen bg-white dark:bg-[#171717] relative">
      ...
      <div className="fixed inset-0 z-50 bg-black/10 backdrop-blur-md flex items-center justify-center">
        ...
        <div className="bg-[#212121]/70 backdrop-blur-md p-8 md:p-10 lg:p-12 rounded-2xl border border-[#5C8EFF]/30 max-w-2xl w-[90%] mx-auto text-center relative overflow-hidden shadow-2xl my-4 md:my-6">
          ...
          <p className="text-gray-100 text-xl mb-6 relative z-10 font-[200] tracking-wide">Coming Soon</p>
          <p className="text-gray-200 mb-6 md:mb-8 lg:mb-10 relative z-10 max-w-xl mx-auto px-2 sm:px-4 font-[200]">
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <motion.p 
              className="text-gray-600 dark:text-gray-400 font-[200]"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Get early access to Elastos developments, events, and initiatives before they're publicly announced.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Receive official recognition as an Elastos Ambassador with a profile on our website and social media channels.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Connect with like-minded individuals and expand your professional network in the blockchain space.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Earn rewards for your contributions to the Elastos ecosystem and ambassador activities.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Make a meaningful impact in shaping the future of the internet and helping build a more decentralized web.</p>
            </motion.div>
            ...
            >
              ...
              <p className="text-gray-600 dark:text-gray-400 font-[200]">Access exclusive educational resources and training materials to deepen your knowledge of Elastos and blockchain technology.</p>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-8 font-[200]">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="bg-white dark:bg-[#212121] p-6 rounded-lg shadow-sm border border-gray-200 dark:border-gray-800">
              ...
              <ul className="space-y-2 text-gray-600 dark:text-gray-400 font-[200]">
