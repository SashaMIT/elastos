          ...
          <div className="space-y-32">
            ...
            <div className="max-w-4xl mx-auto text-center mb-16">
              ...
              <div className="flex flex-wrap justify-center gap-4 mt-8">
                <a 
                  href="/ecosystem" 
                  className="inline-flex px-3 py-2 bg-[rgba(92,142,255,0.15)] text-white border-[rgba(92,142,255,0.25)] rounded-full font-[200] transition-all items-center gap-1 border text-sm"
                >
                  <span>Explore Ecosystem</span>
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 35 34" fill="none">
                    <circle cx="17.333" cy="17" r="16.75" stroke="#5C8EFF" strokeOpacity="0.25" strokeWidth="0.25"/>
                    <path d="M17.3338 22.9405L23.2741 17.0002L17.3338 11.0598L16.4162 11.9774L20.7628 16.324H10.8622V17.6763H20.7628L16.4162 22.0229L17.3338 22.9405Z" fill="#5C8EFF"/>
                    <path d="M20.7628 17.6638H10.8747V16.3365H20.7628H20.7929L20.7716 16.3152L16.4338 11.9774L17.3338 11.0775L23.2564 17.0002L17.3338 22.9228L16.4338 22.0229L20.7716 17.6851L20.7929 17.6638H20.7628Z" stroke="#5C8EFF" strokeOpacity="0.25" strokeWidth="0.025"/>
                  </svg>
                </a>
                <a 
                  href="/team" 
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-16">
              ...
              <a 
                href="/dao" 
                className="inline-flex px-3 py-2 bg-[rgba(246,146,26,0.15)] text-white border-[rgba(246,146,26,0.25)] rounded-full font-[200] transition-all items-center gap-1 border text-sm"
              >
                <span>MC Explorer</span>
                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 35 34" fill="none">
                  <circle cx="17.333" cy="17" r="16.75" stroke="#F6921A" strokeOpacity="0.25" strokeWidth="0.25"/>
                  ...
                  <path d="M20.7628 17.6638H10.8747V16.3365H20.7628H20.7929L20.7716 16.3152L16.4338 11.9774L17.3338 11.0775L23.2564 17.0002L17.3338 22.9228L16.4338 22.0229L20.7716 17.6851L20.7929 17.6638H20.7628Z" stroke="#F6921A" strokeOpacity="0.25" strokeWidth="0.025"/>
                </svg>
              </a>
            </div>
