...
const SocialChannelsPage: React.FC = () => {
  const socialChannels = [
    ...
    },
    {
      ...
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-10 w-10 text-white" viewBox="0 0 24 24" fill="currentColor"><path d="M12 0C5.376 0 0 5.376 0 12s5.376 12 12 12 12-5.376 12-12S18.624 0 12 0zm5.568 8.16c-.18.78-.96 4.44-1.56 6.66-.156.54-.516 1.38-.996 1.68-.9.42-1.596.24-2.4-.3-.492-.36-2.964-1.98-3.96-2.76-.12-.12-.24-.24 0-.48.78-.78 1.8-1.8 2.4-2.4 1.116-1.116.996-1.236 0-2.16l-3.24-2.16c-.3-.3-1.2.06-1.2.06l-3.36 2.16c-.516.36-1.2.54-1.2 1.5 0 .36.18 1.14.42 1.74 1.536 3.396 3.576 6.6 6.576 8.76 2.4 1.74 4.56 1.92 5.94 1.98 1.74.06 3.336-1.62 3.336-3.24 0-.72.3-3.6.3-3.6.3-.96.9-2.28.9-2.28.24-.96-.36-1.14-1.56-.48z"/></svg>,
