  ...
  const keyContributors = [
    {
      ...
      bioShort: "Rong Chen is the visionary behind Elastos. With over 30 years of operating systems development experience, including 18 years at Microsoft, Rong has dedicated his career to creating a safer and more decentralized internet architecture. As a pioneering software engineer and graduate of Tsinghua University, he conceived the idea of a network operating system to secure internet applications, which ultimately evolved into Elastos.",
    ...
    },
    {
      ...
      bioShort: "Dr. Sunny Feng Han is a co-founder of Elastos with a Ph.D. in Physics from Tsinghua University. He played a crucial role in translating Rong Chen's technical vision into a viable project. With extensive background in blockchain education, Sunny founded the MIT Blockchain Pillar and served on the first Cyber Republic Council, implementing critical governance changes including token burning, new tokenomics, and improved transparency.",
