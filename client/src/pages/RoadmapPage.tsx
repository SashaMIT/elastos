...
export default function RoadmapPage() {
  ...
  return (
    <>
      ...
      <SEO 
        title="Elastos Roadmap | Development Timeline and Milestones"
        description="Explore the Elastos roadmap—from its origins in 2000 to its future vision, tracking key milestones in building the decentralized World Computer secured by Bitcoin."
        keywords="Elastos roadmap, blockchain development, merged mining, Bitcoin security, Web3 timeline, decentralized infrastructure, BeL2"
      ...
      <WebPageStructuredData
        title="Elastos Roadmap | Development Timeline and Milestones"
        description="Explore the Elastos roadmap—from its origins in 2000 to its future vision, tracking key milestones in building the decentralized World Computer."
        url="/roadmap"
