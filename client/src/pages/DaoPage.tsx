        ...
        <div className="container mx-auto px-4">
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              {/* Stats - Using BentoGrid style */}
              <div className="md:col-span-6 grid grid-cols-2 gap-4">
                {[
                  {
                    title: "Treasury Balance",
                    value: daoStats.treasuryBalance,
                    icon: <Wallet className="w-5 h-5 text-[#F7921A]" />,
                    color: "text-[#F7921A]",
                    bgColor: "bg-[#F7921A]/10",
                    borderColor: "border-[#F7921A]/20"
                  },
                  {
                  ...
                  {
                    title: "Active Voters",
                    value: daoStats.activeVoters,
                    icon: <Users className="w-5 h-5 text-[#F7921A]" />,
                    color: "text-[#F7921A]",
                    bgColor: "bg-[#F7921A]/10",
                    borderColor: "border-[#F7921A]/20"
                  },
                  {
                    title: "Next CR Election",
                    value: "June 2024",
                    icon: <CalendarDays className="w-5 h-5 text-[#8BABFF]" />,
                    color: "text-[#8BABFF]",
                  ...
                  <motion.div
                    ...
                    className={`p-4 relative overflow-hidden group hover:bg-neutral-900 transition-colors duration-300 rounded-xl border ${stat.borderColor}`}
                  >
              ...
              {/* Recent Projects - Using hover effects style */}
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                whileInView={{ opacity: 1, y: 0 }}
                viewport={{ once: true }}
