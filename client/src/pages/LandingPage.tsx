    ...
    <div className="flex flex-col gap- w-full">
        ...
        <div className="relative w-full h-[700px] overflow-hidden rounded-3xl">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center h-full text-white p-4 sm:p-8">
            ...
            <div className="flex gap-4">
              <a 
                href="/vision"
                className="px-4 py-2 bg-[#090e1a] hover:bg-[#090e1a]/90 text-white rounded-full font-medium transition-all flex items-center gap-2 border border-[#5C8EFF]/50"
              >
      ...
      <div className="mt-32">
        ...
        <div className="container mx-auto mt-32 mb-16 text-center">
          <div className="flex items-center justify-center gap-4 mb-12">
            ...
            />
            <h2 className="text-lg sm:text-xl md:text-3xl lg:text-4xl font-bold text-white">
      ...
      <div className="w-full bg-background dark:bg-[#171717]">
        <div className="container mx-auto px-4 md:px-0 mb-0">
          <h3 className="text-xl md:text-2xl lg:text-3xl font-[400] leading-tight text-left mb-0 text-black dark:text-white">
            Our Community
          </h3>
        </div>
        <TestimonialsSection 
