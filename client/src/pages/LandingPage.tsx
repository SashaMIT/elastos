...
const LandingPage = () => {
  // Use state for loading indicators instead of direct hook results
  const [isHashrateLoading, setIsHashrateLoading] = useState(false);
  ...
  // Function to fetch all data when update button is clicked
        ...
        <div className="relative w-full h-[700px] overflow-hidden rounded-3xl">
          ...
          <div className="absolute inset-0 w-full h-full">
            ...
            <div className="absolute inset-0 w-full h-full z-20 overflow-hidden">
              <iframe 
                className={`absolute top-0 left-0 w-[100%] h-[100%] ${window.innerWidth <= 768 ? 'scale-[1.95]' : 'scale-[0.75]'}`}
          ...
          <div className="absolute inset-0 bg-black/30" style={{ zIndex: 30 }}></div>
