        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto mb-10">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">Elacity</h3>
              <p className="text-white/70 text-sm">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">Glide Finance</h3>
              <p className="text-white/70 text-sm">
            ...
            >
              ...
              <h3 className="text-xl font-bold text-white mb-2">BeL2</h3>
              <p className="text-white/70 text-sm">
